...
import classes from './Parkings.module.css'
...
const Parkings = props => {
    ...
    useEffect(() => {
        axios.get('https://travelling-guide-ca721-default-rtdb.europe-west1.firebasedatabase.app/parkings.json')
            .then(res => {
    ...
    return (
        <div className={classes.Parkings}>
